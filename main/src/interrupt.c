...
#define BUZZER_2_3KHz		869	// (1/2.3KHz)*8MHz/4;
//It's Used for Buzzer.	//130119Ja01
void vInitialPWMB(void)
{
	PWMB_DISABLE;
	PWMB_TIMER_DISABLE;	//Set TBEN to close for saving energy.
	PWMB_PRESCALER_1_4;
	PWMB_CLOCK_SOURCE_FM;	//130301Ja01
	vSetPWMBPeriod(BUZZER_2_3KHz);
	vSetPWMBHighDuty(BUZZER_2_3KHz/2);
}
